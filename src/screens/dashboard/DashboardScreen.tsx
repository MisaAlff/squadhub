    ...
    <View className="mb-3 flex-row overflow-hidden rounded-2xl bg-white shadow-sm">
      ...
      <View className="flex-1 flex-row items-center gap-3 p-4">
        ...
        <View className="flex-1">
          ...
          <Text className="mt-0.5 text-base font-bold text-zinc-900">{title}</Text>
          <Text className="mt-0.5 text-sm text-zinc-500">{subtitle}</Text>
        </View>
      </View>
    </View>
  );
  ...
  const stats = [
    {
      ...
      icon: <Ionicons name="calendar-outline" size={18} color="#71717a" />,
    },
    {
      label: 'Vitórias',
      value: data.wins,
      variant: 'success' as const,
      icon: <Ionicons name="trophy-outline" size={18} color="#15803d" />,
    },
    {
      label: 'Empates',
      value: data.draws,
      variant: 'warning' as const,
      icon: <Ionicons name="remove-outline" size={18} color="#ca8a04" />,
    },
    {
      label: 'Derrotas',
      value: data.losses,
    ...
    },
    {
      ...
      value: data.goalsFor,
      variant: 'default' as const,
      icon: <Ionicons name="football-outline" size={18} color="#71717a" />,
    },
    {
      label: 'Gols sofridos',
      value: data.goalsAgainst,
      variant: 'default' as const,
      icon: <Ionicons name="shield-outline" size={18} color="#71717a" />,
    },
    {
      label: 'Saldo de gols',
      value: goalDiff,
      variant: goalDiffVariant,
      icon: <Ionicons name="trending-up-outline" size={18} color="#71717a" />,
    },
    {
      label: 'Aproveitamento',
      value: `${data.winRate}%`,
      variant: 'default' as const,
      icon: <Ionicons name="stats-chart-outline" size={18} color="#71717a" />,
    },
  ];
